<template>
  <h3-layout class="designer">
    <h3-layout-sider v-model="leftWidth" :left="false">
      <component-panel>
    ...
    <h3-layout-sider v-model="rigthWidth" :left="true">
      <property-panel
        v-if="active"
        :uid="active.id"
        :schema="activeSchema"
...
import {
  ...
  DesignerNode,
  DesignerBackEvent,
  DesignerForwardEvent,
} from './../../designer-core';

import page from './assets/page';

import { factory } from './../../designer-core/property-panel';
