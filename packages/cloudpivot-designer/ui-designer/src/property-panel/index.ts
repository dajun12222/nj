import {
  ...
  RefPropertyInfo,
  ComponentItem,
} from './../../../designer-core/property-panel';
...
register.components = {
  ...
  [ComponentType.VerticalAlignRadio]: () =>
    import('./text/vertical-align-radio.vue'),
  [ComponentType.TextDecorationRadio]: () =>
    import('./text/text-decoration-radio.vue'),
...
register.componentMap = (
  ...
  displaySettings?: PropertyDisplaySettings,
) => {
  if (
    displaySettings &&
    displaySettings.component &&
    displaySettings.component.type
  ) {
