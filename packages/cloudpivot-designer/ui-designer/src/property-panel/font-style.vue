      ...
      <div class="item">
        ...
        <div class="desc">
          <a-radio-group
            ...
            @change="(evt) => onPropChange('textDecoration', evt.target.value)"
          >
      ...
      <div class="item">
        ...
        <div class="desc">
          <a-radio-group
            ...
            @change="(evt) => onPropChange('textTransform', evt.target.value)"
          >
    ...
    <div class="line">
      <div class="item">
        ...
        <div class="desc">
          <a-radio-group
            v-model="textAlign"
            @change="(evt) => onPropChange('textAlign', evt.target.value)"
          >
