...
function buildOptions(
  propInfo: PropertyInfo | RefPropertyInfo | AnyValuePropertyInfo,
  required = false,
  defaultValue?: any,
): any {
  ...
  switch (type) {
    ...
    case DataType.Object:
      opt.children = buildObjectOptions(
        propInfo as ObjectPropertyInfo,
        default1,
      );
      break;

    case DataType.Array:
      ctrlType = buildArrayOptions(
        opt,
        propInfo as ArrayPropertyInfo,
        default1,
      );
      break;
  }
  ...
  if (default1 !== undefined && default1 !== null) {
    ...
    if (AnyValue) {
      ...
      typeof default1 !== 'object' &&
      typeof default1 === typeof value
    ) {
      value = default1;
    }
  }
...
export function buildArrayOptions(
  opt: any,
  propInfo: ArrayPropertyInfo,
  defaultValue?: any[],
) {
