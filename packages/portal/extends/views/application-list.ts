...
export default class AppList2 extends Vue {
  ...
  setFilterData(data: any) {
    ...
    console.log('queryConditionSource========>', this.queryConditionSource);
          ...
          if (value === 0) {
            ...
            if (column.displayFormat) {
              ...
              if (
                ...
                //处理小数精度问题
                let m = 0;
                const s1 = Number(obj[key].split('%')[0]).toString();
                const s2 = '100';
                try {
                  m += s1.split('.')[1].length;
                } catch (e) {}
      ...
      vm.$confirm({
        ...
        content: h('div', { class: 'delete-content' }, [
          h('div', { class: { hidden: !countObj.count1 } }, [
            h('img', {
              attrs: {
                src: require('cloudpivot/list/src/components/pc/image/dot.png'),
              },
            }),
            '业务数据 ',
   ...
   * 导出列表
   */
  handleExportData(data: any, appendParam) {
