...
export default {
  ...
  workbench: {
    root: {
      ...
      meta: { title: site.title + '-工作台' },
      component: () =>
        import('@/views/workflow-center/workbenchInfo/workbenchView.vue'),
    ...
    workbench: {
      ...
      meta: { title: site.title + '-工作台' },
      component: () =>
        import('@/views/workflow-center/workbenchInfo/workbench.vue'),
    ...
    draftList: {
      ...
      component: () =>
        import('@/views/workflow-center/workbenchInfo/draftList.vue'),
    },
    messageNotification: {
      ...
      component: () =>
        import('@/views/workflow-center/workbenchInfo/messageNotification.vue'),
    },
  },
