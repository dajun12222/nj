...
<template>
  <div class="header common-header">
    <div class="logo" @click="goHome">
      <img :src="logo" alt />
      <a v-if="isDingTalk" class="open-blank" @click.prevent="openBlank">在浏览器中打开</a>
    </div>
        ...
        <ul>
          ...
          <li>
            <a-dropdown :trigger="['click']">
              ...
              <div slot="overlay" class="info-box">
                <ul>
                  ...
                  <li v-if="isShowToggle">
                    <a class="toggle-lang" @click="toggleLanguage">
    ...
    >
      ...
      >
        ...
        <a-col :span="19">
          ...
          <p v-if="oldPwdErrTips" class="err-tips">
            {{ oldPwdErrTips }}
          </p>
        </a-col>
      </a-row>
      ...
      >
        ...
        <a-col :span="19">
          ...
          <p v-if="newPwdErrTips" class="err-tips">
            {{ newPwdErrTips }}
          </p>
        </a-col>
      </a-row>
