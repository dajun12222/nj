 ...
 * @LastEditTime: 2022-04-13 15:53:19
 * @FilePath: \yunshu6.0\packages\portal\src\views\workflow-center\query-instance.vue
 * @Description:
-->
<template>
  <query-instance :storeId="storeId" @openForm="openForm" />
</template>
