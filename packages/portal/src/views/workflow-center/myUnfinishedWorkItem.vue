 ...
 * @LastEditTime: 2022-04-13 15:53:44
 * @FilePath: \yunshu6.0\packages\portal\src\views\workflow-center\myUnfinishedWorkItem.vue
 * @Description:
-->
<template>
  <my-unfinished-work-item :storeId="storeId" @openForm="openForm" />
</template>
