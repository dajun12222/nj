  ...
  implements renderer.RelevanceFormService
{
  search(
    ...
    const obj: any = {
      ...
      mobile: false,
      page: arg[0] || 0,
      size: 1000, //关联单选调用最多获取1000条数据
      pageSize: arg[1] || undefined,
      reverseSchemaParam: arg[4] || null,
    ...
    if (arg[5] && arg[5].tempAuthSheetId) {
      obj.tempAuthSheetId = arg[5].tempAuthSheetId
      obj.tempAuthObjectId = arg[5].tempAuthObjectId
      obj.tempAuthPropertyCode = arg[5].tempAuthPropertyCode
    }
