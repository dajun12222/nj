<template>
  <div id="MyFinishedWorkitem" ref="workItem" class="workitem-box">
    ...
    <div v-if="isShowTableBox" class="table-box">
      ...
      <div ref="table" class="table">
        ...
        >
          ...
          <template slot="approvalTxt" slot-scope="{ text }">
          ...
          <template slot="workflowInstanceStateTxt" slot-scope="{ text }">
            <span class="text-ellipsis">{{ text }}</span>
          </template>
