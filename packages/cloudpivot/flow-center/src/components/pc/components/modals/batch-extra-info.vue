<template>
  ...
  >
    <a-row type="flex">
      <a-col :span="4">
        {{ $t('cloudpivot.flowCenter.pc.approveSuggestion') }}:
      </a-col>
      <a-col :span="19">
        <a-textarea v-model="remark" placeholder="请输入审批意见" :rows="4" />
      </a-col>
    </a-row>
...
//import ApproveOpinion from "../../../../../../form/src/renderer/components/pc/approve-opinion.vue";
