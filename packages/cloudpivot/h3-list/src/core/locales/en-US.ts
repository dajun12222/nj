export default {
  ...
  customActionInnerTopComment:
    'The order can be adjusted using <alt+[arrow keys]>; the default operation buttons cannot be deleted;',
  // 预设模板注释
  presetTemplateTopComment: '',
  presetTemplateInnerTopComment: '',
  presetTemplateInnerTHeadComment:
    'You can use <alt+[arrow keys]> to adjust the field order; other modifications are invalid. To customize, please use the custom template below.',
  presetTemplateInnerTBodyComment: '',
  // 自定义模板
  customTemplateTopComment:
    'Here you can write a custom template, the content of the preset template will not be rendered when the effective content is written here.',
