              ...
              <div class="form-approval__content">
                ...
                <div class="form-approval__info">
                  <div class="row">
                    ...
                    <span v-if="approval.subInstanceActivity">{{
                      getWorkItemStatus(node.workItemStatus)
                    }}</span>
                    <template
                      v-else-if="
                        node.workActionType && node.workActionType !== 12
                      "
                    >
                      <label
                      ...
                      >
                        <span
                          v-if="
                            ![9, 17, 18, 19, 20].includes(node.workActionType)
                          "
                          >{{
                            getWorkflowActionStatus(node.workActionType, node)
                          }}</span>
                      </label>
                    </template>
              ...
              <template v-if="!approval.subInstanceActivity">
                ...
                >
                  ...
                  >
                    ...
                    <template
                      v-for="(user, userIdx) in node.bizComment.userInfos"
                      >{{ user.name
                      }}<template
...
import { DefaultFileService } from '../../../../common/src/config/mobile/h3-form/file-service';
@Component({
  name: 'form-approval',
  components: {
    H3Avatar,
