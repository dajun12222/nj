    ...
    <div class="down-body">
      <div class="down-progress">
        <div class="down-progress-inner">
          ...
          <span class="progress-count">已生成数 {{ successNum }}/{{ totalNum }}</span>
        </div>
      </div>
      <div class="down-box">
                    ...
                    >
                      ...
                      <div class="list-item-right">
                        <div class="list-item-right-box">
                          <span v-if="item.status === 4" class="build-status">已生成</span>
                          <span
            ...
            <div class="page-nation">
              ...
              >
                <template slot="buildOptionText" slot-scope="props">
                  <span v-if="props.value !== '99999'">{{ props.value }}条/页</span>
