      ...
      <div ref="sheetHead" class="sheet__row sheet__head">
        ...
        <template v-for="(col, colIdx) in leftColumns">
          ...
          >
            ...
            >
              {{ col.title }}
              <a-tooltip v-if="col.tips" :title="col.tips">
                ...
                >
                  <template v-for="(childCol, childIdx) in col.children">
                    ...
                    >
                      ...
                      <div v-else>
                        {{ childCol.title }}
                        <a-tooltip v-if="childCol.tips" :title="childCol.tips">
                          <a-icon type="question-circle-o" />
                        </a-tooltip>
                      </div>
                    </h3-size-slider>
        ...
        >
          <template>
            <div class="action-column form-sheet-action-column">操作</div>
          </template>
        </div>
        <!--          列表动态配置-->
        <div
        ...
        >
          <template>
            <div class="action-column">操作列</div>
          </template>
        </div>
      </div>
        ...
        >
          ...
          >
            <a-dropdown :trigger="['click']" :placement="bottomLeft">
              ...
              >
                <a-menu-item key="copy"> 复制行 </a-menu-item>
                <a-menu-item key="delete"> 删除行 </a-menu-item>
                <a-menu-item key="empty"> 清空行 </a-menu-item>
                <a-menu-item key="unshift"> 在上面添加行 </a-menu-item>
                <a-menu-item key="append"> 在下面添加行 </a-menu-item>
              </a-menu>
            </a-dropdown>
          </div>
