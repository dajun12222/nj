import * as WorkflowCenter from '../../../../../list/src/typings/workflow-center';
...
import * as numberFormatter1 from '../../../../../form/utils/number-formatter';
...
export function numberToDisplay(value: any, column: any) {
  ...
  switch (column.displayFormat) {
    ...
    case 2:
      result = addZero(
        Number(result.toFixed(2).slice(0, -1)).toLocaleString(),
        1,
      );
      break;
    case 3:
      result = addZero(
        Number(result.toFixed(3).slice(0, -1)).toLocaleString(),
        2,
      );
      break;
    case 4:
    ...
    case 15:
      result = `￥${addZero(
        numberFormatter(result.toFixed(4).slice(0, -1)),
        3,
      )}`;
      break;
    case 16:
      result = `￥${addZero(
        numberFormatter(result.toFixed(5).slice(0, -1)),
        4,
      )}`;
      break;
    case 17:
    ...
    case 31:
      result = `￥${addZero(
        numberFormatter(result.toFixed(6).slice(0, -1)),
        5,
      )}`;
      break;
    case 32:
      result = `￥${addZero(
        numberFormatter(result.toFixed(7).slice(0, -1)),
        6,
      )}`;
      break;
    case 33:
      result = `￥${addZero(
        numberFormatter(result.toFixed(8).slice(0, -1)),
        7,
      )}`;
      break;
    case 34:
      result = `￥${addZero(
        numberFormatter(result.toFixed(9).slice(0, -1)),
        8,
      )}`;
      break;
    case 35:
