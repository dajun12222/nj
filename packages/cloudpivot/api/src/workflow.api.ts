...
export class WorkflowApi {
   ...
   */
  getRejectActivities(
    params: wf.GetRejectActivitiesParams,
   ...
   * @param params
   */
  rejectWorkItem(params: wf.RejectParams): Promise<HttpResponse<void>> {
   ...
   */
  revokeWorkItem(
    params: wf.RevokeWorkitemParams,
   ...
   * @param workflowInstanceId
   */
  finishInstance(workflowInstanceId: string): Promise<HttpResponse<void>> {
  ...
  updateCirculateReaded(
    params: wf.UpdateCirculateReadedParams,
  ): Promise<HttpResponse<void>> {
   ...
   * 转办
   */
  forwardWorkItem(params: wf.ForwardParams): Promise<HttpResponse<void>> {
   ...
   * 协办
   */
  assistWorkItem(params: wf.AssistParams): Promise<HttpResponse<void>> {
   ...
   * 传阅
   */
  circulateWorkItem(params: wf.AssistParams): Promise<HttpResponse<void>> {
   ...
   * @param params
   */
  cancelActivity(params: any): Promise<HttpResponse<void>> {
   ...
   * @param params
   */
  activateActivity(params: any): Promise<HttpResponse<void>> {
   ...
   */
  getApproval(
    params: wf.GetWorkflowTrackParams,
   ...
   * @param params
   */
  getWorkflowOperationLog(
    params: wf.GetWorkflowTrackParams,
  ): Promise<HttpResponse<wf.WorkflowOperationLog[]>> {
   ...
   * 调整当前处理人
   */
  adjustParticipantors(params: any): Promise<HttpResponse<void>> {
  ...
  getWorkflowNodes(
    ...
    return axios.get(Mappings.workflow.listWorkflowInstanceActivity, {
      params,
    });
  }
  ...
  getWorkflowBaseInfo(
    params: wf.GetWorkflowTrackParams,
  ): Promise<HttpResponse<wf.InstanceBaseInfo>> {
  ...
  getWorkflowLogs(
    params: wf.GetWorkflowTrackParams,
  ): Promise<HttpResponse<wf.WorkflowTrackLog[]>> {
  ...
  compareOperationLog(bizObjectLogId: string) {
    return axios.get('/api/runtime/workflow/compareOperationLog', {
      params: { bizObjectLogId },
    });
  }
  ...
  getWorkflowInstanceErrInfo(workflowInstanceId: string) {
    return axios.get(Mappings.workflow.workflowInstanceErr, {
      params: { workflowInstanceId },
    });
  }
  ...
  getWorkflowAdminManageScopes(params: any) {
    return axios.get(`/api/workflow/get_workflow_admin_manage_scopes`, {
      params,
    });
  }
  ...
  getWorkflowAdminManageScopesByWorkflowInstanceId(params: any) {
    return axios.get(`/api/runtime/workflow/get_workflow_admin_manage_scopes`, {
      params,
    });
  }
}
