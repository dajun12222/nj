import { getComponentOptionsByControlType } from '../../../../form/utils';
    ...
    if (op) {
      ...
      switch (controlType) {
        ...
        case typings.FormControlType.Logic:
          ...
          break;
        case typings.FormControlType.Time:
          options = new typings.TimeOptions();
          break;
        case typings.FormControlType.TimeRange:
          options = new typings.TimeOptions();
          break;
        ...
        case typings.FormControlType.OwnerParentId:
