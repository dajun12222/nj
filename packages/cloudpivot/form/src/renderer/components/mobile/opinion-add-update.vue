...
<template>
  <div class="container">
    <div class="container-title">
      <div class="container-title-cancel" @click="cancel">
      ...
      <div class="container-title-subTitle">
        {{
          type === 'add'
            ...
            : $t('cloudpivot.form.renderer.updateDatas')
        }}
      </div>
      <div
    ...
    <div class="container-content">
      ...
      />
      <div v-if="id" class="container-content-order">
...
import { H3Button, H3Input, H3Textarea } from 'h3-mobile-vue';
