...
import { AddressControl, FormLocationControl } from '../../controls';
...
@Component({
  ...
  components: {
    PcaSelector: () =>
      import(
        '../../../../../form/src/common/components/mobile-pca-selector/pca-selector.vue'
      ),
    H3Textarea,
    MutilText,
    SmartLocation: () =>
      import('../shared/mobile-smart-location/smart-location.vue'),
  },
})
