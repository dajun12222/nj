<template>
  <div class="address dd">
    <template v-if="!readonly">
      ...
      <div v-if="controlOpts.addressDetail === 'true'" class="address-textarea">
        <a-textarea
          v-model="val.address"
...
@Component({
  ...
  components: {
    ...
    AIcon: Icon,
    SmartLocation: () =>
      import('../../../common/components/smart-location/index.vue'),
    PcaSelector: () =>
      import('../../../common/components/pca-selector/pca-selector.vue'),
  },
})
