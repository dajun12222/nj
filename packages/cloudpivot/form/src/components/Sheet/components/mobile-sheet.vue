  ...
  >
    ...
    <template v-else>
      ...
      <div class="h3-rows" :class="{ horizontal: isHorizontal }">
        ...
        >
          <div v-show="!isHorizontal" class="h3-form-sheet-col-title sheet-row">
            {{
...
import RelevanceFormModal from '../../../../../form/src/common/components/relevance-form-modal2.vue';
...
import BaseControlAdapter from '../../../../../form/src/renderer/components/mobile/base-control-adapter.vue';
