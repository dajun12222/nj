<template>
  <div class="pca-selector">
    <div class="pca-selector--row" @click="getFocus">
      <div>
        ...
        <div class="field__content">
          {{ valString }}
          <label v-if="pcaDate.length === 0 && !readonly" class="placeholder">{{
    ...
    <h3-modal :show="isFocus" type="popup" :appendToBody="true">
      <div class="pca-selector--options">
        <div class="options-header">
          ...
          <i class="clear icon aufontAll" @click="clear">&#xe994;</i>
        </div>
        <div v-if="isFocus" class="options-content">
          <h3-swiper v-model="activeTab" :showDots="false">
            <h3-swiper-item v-if="showTab[0]">
              <ul>
                <li v-if="showEmpty" @click="emptyClick('p')">
                  {{ $t('cloudpivot.form.renderer.pleaseSelect') }}
                </li>
                <li
                ...
                >
                  {{ p.name }}
                  <span v-show="p.selected && !animating" class="icon aufontAll">&#xe98f;</span>
                </li>
              </ul>
            </h3-swiper-item>
            ...
            <h3-swiper-item v-if="showTab[1]">
              <ul>
                <li v-if="showEmpty" @click="emptyClick('c')">
                  {{ $t('cloudpivot.form.renderer.pleaseSelect') }}
                </li>
                <li
            ...
            <h3-swiper-item v-if="showTab[2] && showDistrict">
              <ul>
                <li v-if="showEmpty" @click="emptyClick('a')">
                  {{ $t('cloudpivot.form.renderer.pleaseSelect') }}
                </li>
                <li
