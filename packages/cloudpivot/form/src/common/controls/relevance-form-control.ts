...
import { formatVal } from './../../../../list/src/components/pc/components/queryForm/query-form-util';
    ...
    const params = conditions
      ...
      .map((arr) => {
        ...
        if (f2[0] === '{') {
          ...
          let _formatVal;
          if (theCondition1 && theCondition1.propertyType === 50) {
