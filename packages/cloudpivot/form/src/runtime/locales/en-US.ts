...
export default {
  ...
  tip: {
    ...
    [FormAction.Delete]:
      'The item be restored after deletion. Are you sure you want to delete it?',
    ...
    errTips11:
      'Detected that some participants have participated in the current node, so the task can no longer be processed!',
    errTips12: 'Not allowed to adjust yourself!',
    errTips13: 'The data used for validation does not exist!',
    errTips14:
      'Field does not exist in the model which in logical check on business rｕle!',
    errTips15:
      'The field of the business rule logic node target model does not exist!',
    errTips16:
      'Data which be check does not exist, please contact the administrator for processing',
    ...
    errTips19:
      'The business rule logic check failed, please contact the administrator to deal with!',
    errTips20:
  ...
  modal: {
    ...
    reject: 'Reject to',
    canNotReject: 'Non-parallel nodes are not allowed to reject simultaneously',
    writeApplication: 'Fill out application form',
    ...
    trustTips:
      'You are helping [{name}] to initiate the [{workflowname}] process.',
    ...
    participantChoose: 'Participant selection',
    nextNodeName: 'Next node name',
    nextNode: 'Next node',
    chooseParticipant: 'Please select participants',
    selectParticipant: 'Go choose choose',
    nextNodeTips:
      'The next approval node "{nodeName}" does not select a participant, do you still submit the form?',
    yes: 'YES',
  },
