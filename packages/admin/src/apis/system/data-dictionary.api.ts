...
export default {
  // 新增/保存数据字典
  saveDictionary(params: any): Promise<Common.Res<void>> {
    return axios.post('/api/data_dictionary/saveDictionary', params);
  },

  // 获取字典分类
  getDictionaryClass(params: any): Promise<Common.Res<void>> {
    return axios.get('/api/data_dictionary/getDictionaryClass', { params });
  },

  // 获取字典列表
  searchDictionary(params: any): Promise<Common.Res<void>> {
    return axios.get('/api/data_dictionary/searchDictionary', { params });
  },

  // 禁用/启用数据字典
  updateDictionaryStatus(params: any): Promise<Common.Res<void>> {
  ...
  searchDictionaryRecord(params: any): Promise<Common.Res<void>> {
    return axios.get('/api/data_dictionary/searchDictionaryRecord', { params });
  },

  // 新建字典分类
  saveDictionaryClass(params: any): Promise<Common.Res<void>> {
    return axios.post('/api/data_dictionary/saveDictionaryClass', params);
  },

  // 获取字典列表
  getDictionaryIdAndNames(params: any): Promise<Common.Res<void>> {
  ...
  // 获取字典分类
  getDictionaryClassDetail(params: any): Promise<Common.Res<void>> {
  ...
  // 批量删除分类
  deleteDictionaryClassBatch(params: any): Promise<Common.Res<void>> {
    return axios.post(
  ...
  // 根据字典类型获取数据字典
  getDictionaryByType(params: any): Promise<Common.Res<void>> {
    return axios.get('/api/data_dictionary/getDictionaryByType', { params });
  },

  // 获取启用的字典数据
  getEnableRecordsByDictionaryId(params: any): Promise<Common.Res<void>> {
