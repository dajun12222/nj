...
export default {
  ...
  exportRole(params: any): any {
    return Axios.post('/api/organization/role/export_role', params, {
      responseType: 'arraybuffer',
    });
  },

  // exportRole(params: any): any {
  //   return Axios.get('/api/organization/role/export_role', { params });
  // },
  ...
  getOrgListByName(params: any): Promise<Common.Data> {
    return Axios.get('/api/organization/department/keyword/users', { params });
  },
  ...
  getRoleLeveOneInfoNew(expandAll?: boolean,appCode?:string): Promise<Common.Response> {
    // 组织角色
  ...
  // 重置密码
  defaultPassword(): Promise<Common.Data> {
    return Axios.get('/api/organization/user/getDefaultPwd');
  },
  ...
  getOrgUserDepList(params: any): Promise<Common.Data> {
  ...
  // 查询是否可删除
  deleteCheck(params: any): Promise<Common.Response> {
    return Axios.delete('/api/system/relatedcorp/delete_check', { params });
  },

  // 删除关联组织
  deleteOrgan(params: any): Promise<Common.Response> {
  ...
  //是否具有编辑角色权限
  getUserEditRoleOauth(): Promise<Common.Data> {
    return Axios.post("/api/public/ceec/role/getUserEditRoleOauth");
  },
  // 错误处理
  errorHandle(res: any) {
  ...
  exportRoleTemplate(): any {
    return Axios.get('/api/organization/role/export_template', {
      responseType: 'arraybuffer',
    });
  },
...
// 根据userId获取用户可交接的角色
export const queryUserMaintainRole = (params: any): Promise<Common.Data> => {
...
export const importRole = (fileName: string): Promise<Common.Data> => {
  return Axios.get('/api/organization/role/import_data', {
    params: {
      fileName,
    },
  });
