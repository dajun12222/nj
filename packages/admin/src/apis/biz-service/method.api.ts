...
export default {
   ...
   */
  listMethodsByCode(
    params: BizService.Method.ListByCodeParams,
   ...
   */
  deleteMethod(
    params: BizService.Method.DeleteParams,
  ): Promise<Common.Response> {
   ...
   */
  updateMethod(
    params: BizService.Method.UpdateParams,
  ): Promise<Common.Response> {
   ...
   */
  getMethodDetails(
    params: BizService.Method.DetailsParams,
  ): Promise<Common.Res<BizService.Method.Item>> {
   ...
   */
  listDataTable(
    params: BizService.Method.ListDatatableParams,
  ): Promise<Common.Data> {
  ...
  listDataTableColumns(
    params: BizService.Method.ListDatatableColumnParams,
  ): Promise<Common.Data> {
   ...
   * 创建实体表集成方法
   */
  createDatatableMethods(
    params: Array<BizService.Method.CreateParams>,
  ): Promise<Common.Data> {
  ...
  getListDatasourceMethods(params): Promise<Common.Data> {
    return axios.get('/api/bizdatasource/method/list_by_category_id', {
      params,
    });
  },
