...
<template>
  ...
  >
    <div class="user-selection-warp">
      ...
      >
        <span slot="attributesTitle">{{
          $t('languages.Apps.FormDesignPage.Attributes')
        }}</span>
        <span slot="dataItemTitle">{{
          $t('languages.Apps.FormDesignPage.DataItem')
        }}</span>
        <span slot="actionTitle" class="delete">{{
...
import { Modal, Select, Table } from '@h3/antd-vue';
