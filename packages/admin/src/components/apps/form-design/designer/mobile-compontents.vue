...
<template>
  <div class="h3-moilbe-view">
    ...
    >
      <div class="h3-moilbe-view-common-title header-title">
        {{ control.options.name }}
      </div>
    </div>

    <div v-else-if="!smartOrg" class="h3-moilbe-view-common">
      <div
      ...
      >
        <div
          ...
          class="h3-moilbe-view-common-title-cover"
        ></div>
        <span :class="control.type === 200 ? 'bold' : ''">{{
          control.options.name
        }}</span>
      </div>
    ...
    <div v-else class="h3-moilbe-view-org">
