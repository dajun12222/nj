  ...
  <div class="permission-from-wrap">
    ...
    >
      ...
      <a-form-item
        ...
        label="选择数据流"
      >
        <a-select mode="multiple" placeholder="请选择" @change="steamChange">
          <a-select-option
            v-for="dataSteam in filterDataSteamList"
            :key="dataSteam.objectId"
          >
      ...
      <a-form-item
        ...
        label="添加使用者"
      >
        <a-select mode="multiple" placeholder="请选择" @change="memberChange">
...
import { Button, Form, Select, Input } from '@h3/antd-vue';
