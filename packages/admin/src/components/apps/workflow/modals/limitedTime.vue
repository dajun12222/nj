            ...
            !(
              (processTime.dayValue ||
                ...
                (timeoutCondition === 'in_form' &&
                  processTime.timeConfig === 'then')) &&
              (timeoutWarning1.dayValue ||
                timeoutWarning1.hourValue ||
                timeoutWarning1.minuteValue)
            )
          "
          :min="0"
          :max="59"
...
<script lang="ts">
import { Modal, InputNumber, Select, Switch } from '@h3/antd-vue';
