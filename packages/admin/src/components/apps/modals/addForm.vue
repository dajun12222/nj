  ...
  >
    ...
    >
      ...
      <a-form-item
        ...
        :wrapperCol="formItemLayout.wrapperCol"
      >
        <selected-icon v-model="formData.icon" />
      </a-form-item>
      ...
      >
        ...
        >
          <a-radio value="0">
            {{ $t('languages.Apps.SysForm') }}
          </a-radio>
          <a-radio value="1">
            {{ $t('languages.Apps.CusForm') }}
          </a-radio>
        </a-radio-group>
      </a-form-item>
      <!-- 自定义表单部分 -->
      <div v-show="formData.sheetType === '1'">
        ...
        >
          ...
          <a-input
            ...
            :placeholder="$t('languages.Apps.PcUrlPlaceholder')"
          />
        </a-form-item>

        <a-form-item
          :class="
            formData.mobileIsPc ? 'mobile-url-customize' : 'url-form-item'
          "
          class="cus-form"
          ...
          :wrapperCol="formItemLayout.wrapperCol"
        >
          <a-checkbox v-model="formData.mobileIsPc">
            {{ $t('languages.Apps.SameAsPc') }}
          </a-checkbox>
        </a-form-item>
        ...
        >
          ...
          <a-input
            ...
            :placeholder="$t('languages.Apps.PlzInputUrl')"
          />
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="formItemLayout.wrapperCol"
        >
          <a-checkbox v-model="formData.printIsPc">
            {{ $t('languages.Apps.SameAsPc') }}
          </a-checkbox>
        </a-form-item>
...
export default class AddFormModal extends Vue {
  ...
  get title() {
    return this.isEdit
      ? this.$t('languages.Apps.EditForm')
      : this.$t('languages.Apps.AddForm');
  }
        ...
        promise
          .then(
            (res: any) => {
              ...
              this.closeModal();
              this.resetForm();
              this.$message.success(this.$t('languages.SaveSuccess') as string);
            },
            (res) => {
