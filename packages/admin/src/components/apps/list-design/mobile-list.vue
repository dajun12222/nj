      ...
      <div class="mobile-view-content">
        ...
        <div class="view-content">
          ...
          <div class="list-item">
            <MobileItemList
              :isPreview="isPreview"
              :propDataList="queryColumns"
            />
            <div v-if="isShowFilterBox" class="search-content">
            ...
            <!-- 单据状态 -->
            <div v-show="isShowFormStatus" class="search-content status">
              <div class="status-list">
                <ul>
                  ...
                  >
                    ...
                    <span
                      v-if="status.checked"
                      class="check-group icon aufontAll h-icon-all-check-circle checked"
                    ></span>
                    <span
                      v-else
                      class="check-group icon aufontAll h-icon-all-circle-o"
                    ></span>
                  </li>
                </ul>
