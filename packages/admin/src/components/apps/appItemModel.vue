...
<template>
  <div class="business-model">
    ...
    <div class="model-content">
      ...
      <div class="model-content-block">
        ...
        <ul class="block-list">
          <li @click="openBizModel">
            <i class="icon aufontAll h-icon-all-database-o data"></i>
            <p class="item-name">
              {{ $t('languages.Apps.DataModel') }}
            </p>
          </li>
      ...
      <div class="model-content-block">
        <p class="block-title">
          {{ $t('languages.Apps.FormManagement') }}
        </p>
        <ul class="block-list">
          <li
            v-for="form in forms"
      ...
      <div class="model-content-block">
        <p class="block-title">
          {{ $t('languages.Apps.WorkflowManagement') }}
        </p>
        <ul class="block-list">
          <li
          ...
          >
            ...
            <i :class="'icon aufontAll workflow ' + workflow.icon"></i>
            <a-tooltip v-if="showTootip(workflow.workflowName)" placement="top">
      ...
      <div class="model-content-block">
        <p class="block-title">
          {{ $t('languages.Apps.ListManagement') }}
        </p>
        <ul class="block-list">
          <li
