...
<template>
  <div class="tree">
    <div class="content-top">
      ...
      <span class="add" @click.stop="($event) => add($event, 'root', null)"><a-icon type="plus" />添加节点</span>
    </div>
    <tree-content :recordsData="recordsData" :vm="this" :depth="0" />
    ...
    >
      <div class="modal-wrapper">
        <list-item v-if="isAddSub" :label="'父节点'" :showRequire="true">
          <a-input
...
import { Icon, Modal, Input } from '@h3/antd-vue';
