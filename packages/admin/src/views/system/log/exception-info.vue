  ...
  <div class="exception-info">
    <div class="exception-info__content">
        ...
        <a-row>
          ...
          <a-col class="exception-info__item" :span="12">
            <a-row>
              ...
              <a-col :span="18">
                <a @click="$emit('openForm')">{{
                  info.workflowInstanceName
                }}</a>
              </a-col>
            </a-row>
          </a-col>
          ...
          <a-col class="exception-info__item" :span="12">
            <a-row>
              ...
              <a-col :span="18">{{
                info.status === 1 ? info.fixerName : '无'
              }}</a-col>
            </a-row>
          </a-col>
          <a-col class="exception-info__item" :span="12">
            <a-row>
              ...
              <a-col :span="18">{{
                info.status === 1 ? info.fixedTime : '无'
              }}</a-col>
            </a-row>
          </a-col>
        </a-row>
      ...
      <div class="exception-info__card">
        ...
        <a-row class="exception-info__item" type="flex" justify="start">
...
<script lang="ts">
import { Row, Col, Button } from '@h3/antd-vue';
import { components } from 'cloudpivot/form/renderer';
