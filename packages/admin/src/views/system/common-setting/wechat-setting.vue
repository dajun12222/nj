      ...
      <div class="portal-setting__form">
        <a-row class="portal-setting__item">
          ...
          <a-col :span="layout.right" class="portal-setting__right">
            ...
            <a-input v-else v-model="params.name" />
          </a-col>
        </a-row>
        <a-row class="portal-setting__item">
          <a-col :span="layout.left" class="portal-setting__left">
        ...
        <a-row class="portal-setting__item">
          ...
          <a-col :span="layout.right" class="portal-setting__right">
            <span class="portal-setting__right--edit">{{
...
import { Row, Col, Input, Button, Tooltip, Icon } from '@h3/antd-vue';
...
export default class WechatSetting extends Vue {
  ...
  saveDate() {
    ...
    const syncType = 0; // 同步方式 0 PULL 拉取 ,1 PUSH 推送
