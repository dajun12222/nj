  ...
  <div class="left-attr">
    <div class="left-item">
      ...
      <div v-show="whichRadio === 2" class="input-select">
        <a-select
          v-model="itemAttrs.code"
          showSearch
          @change="
            (item) => {
              itemAttrs.innerTxt = `\${ ${item.split('#_#')[2]} }`;
            }
          "
        >
          <a-select-option
    ...
    <div class="left-item">
      ...
      <div class="font-setting">
        <size-dropdown
          :value="itemAttrs.fontSizeValue"
          @change="
            (e) => {
              itemAttrs.fontSizeValue = e;
            }
          "
        />
...
export default class LeftAttribute extends Vue {
  ...
  txtChange(e: any) {
    const selectionStart = e.srcElement.selectionStart;
    const selectionEnd = e.srcElement.selectionEnd;
  ...
  ToDBC(txtstring: string): string {
    ...
    arry.forEach((val: any, index: number) => {
      let space = '';
      if (val === ' ') {
  ...
  onChange(item) {
    this.itemAttrs.innerTxt = `\${ ${item.split('#_#')[2]} }`;
  }
}
</script>
