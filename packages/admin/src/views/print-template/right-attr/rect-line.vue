...
<template>
  <div class="left-attr">
    <div v-if="itemAttrs.eleType.includes('topDrawerLine')" class="left-item">
      <p>方向</p>
      <div class="select-input">
        <a-select
          v-model="itemAttrs.lineDirection"
          showSearch
          title="宽高属性将重置"
        >
    ...
    <Xywh />
    <div v-if="itemAttrs.eleType.includes('topDrawerRect')" class="left-item">
      <p>填充色</p>
    ...
    <div class="left-item">
      ...
      <div class="select-input">
        ...
        <border-dropdown
          v-if="itemAttrs.eleType.includes('topDrawerRect')"
