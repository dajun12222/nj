  ...
  <div class="left-item">
    ...
    <div class="xywh-position">
      <a-input
        ...
        addonAfter="X"
        :disabled="
          leftOrRight.includes('right') && itemAttrs.eleType.includes('column')
        "
      ...
      <a-input
        ...
        addonAfter="高"
        :disabled="
          itemAttrs.eleType.includes('topDrawerLine') &&
          itemAttrs.lineDirection.includes('x')
        "
        class="height"
        @input="input = true"
        @blur="onHeightChange"
      ...
      <span>
        <i
          class="icon aufont lock"
          :class="[locked ? 'icon-base-lock' : 'icon-base-unlock']"
          @click="onLockClick"
        ></i>
      </span>
      ...
      <a-input
        ...
        :disabled="
          itemAttrs.eleType.includes('topDrawerLine') &&
          itemAttrs.lineDirection.includes('y')
        "
        @input="input = true"
        @blur="onWidthChange"
...
export default class Xywh extends Vue {
  ...
  getRatio() {
    return (
      Math.floor((this.xywh.heightValue / this.xywh.widthValue) * 100) / 100
    );
  }
