...
<template>
  <div class="message-reminder">
    ...
    <div v-else class="message-reminder__main">
      <template v-if="list.length">
        <div class="message-reminder__buttons">
          ...
          <a-button icon="plus" type="primary" @click="openDrawer">
    ...
    <a-drawer
      ...
      @close="closeDrawer"
    >
      <reminder-drawer v-if="showDrawer" ref="drawer" :record="record" />
      <div
        :style="{
          position: 'absolute',
          left: 0,
...
import { Spin, Table, Drawer, Switch, Button } from '@h3/antd-vue';
      ...
      if (res.errcode === 0 && res.data) {
        ...
        this.list = res.data.map((resTwo: any, index: number) => {
          ...
          return {
            ...
            condition: vm.setconditionString(
              resTwo.roleCondition,
              resTwo.filterType,
            ),
            ...resTwo,
          };
