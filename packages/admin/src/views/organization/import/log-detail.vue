        ...
        <div class="block">
          ...
          <ul class="list">
            ...
            <li class="item">
              ...
              <div class="value">
                {{ detailData.createrName }}
              </div>
            </li>
            <li class="item">
              <div class="key">用户账号</div>
              <div class="value">
                {{ detailData.createrUserName }}
              </div>
            </li>
            <li class="item">
              ...
              <div
                class="value"
                :style="
                  detailData && detailData.fixedStatus === 0 ? 'color:red' : ''
                "
              >
        ...
        <div class="block">
          ...
          <div class="content clearfix">
            ...
            <div class="value">
              ...
              <template v-else>
                <span v-if="detailData.executeStatus === 1" class="no-detail">暂无异常信息</span><span v-else class="no-detail">暂无内容</span>
              </template>
            </div>
          </div>
        </div>
...
import { Button, Drawer } from '@h3/antd-vue';
