...
import { Spin, Tree } from '@h3/antd-vue';
import { Component, Prop, Vue, Watch } from 'vue-property-decorator';
import { OrgTree, TreeNode, TreeNodeByKey } from './orgTree.typings';
...
export default class OrgTreeComponent extends Vue implements OrgTree {
  ...
  async updateUserNum() {
    ...
    for (const item of this.orgTree) {
